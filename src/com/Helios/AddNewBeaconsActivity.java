...
public class AddNewBeaconsActivity extends Activity{
	...
	private class BeaconListDownloader implements Runnable {
		...
		private void downloadListFromRDS() throws JSONException{
			...
			for(int i = 0; i < beaconArray.length(); i++){
				...
				BeaconInfo oldBeac = new BeaconInfo(uniqueID, major, minor, friendlyName, password, powerLevel);
				...
				BeaconInfo beac = new BeaconInfo(uniqueID, major, minor, friendlyName, password, powerLevel);
		...
		private JSONObject getRequestObj() throws JSONException{
			...
			requestObj.put("query", "get_new_beacons");
