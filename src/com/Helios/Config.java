...
final class Config {
	...
	static final String AUTH_ROLE_ARN = "arn:aws:iam::" + ACCOUNT_ID + ":role/helios-upload";
	static final String UNAUTH_ROLE_ARN = "arn:aws:iam::" + ACCOUNT_ID + ":role/helios-upload";	
